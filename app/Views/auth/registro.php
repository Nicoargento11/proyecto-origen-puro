...
<head>
    ...
    <title>Registro | Origen Puro</title>
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h2><i class="fas fa-coffee me-2"></i>Únete a Origen Puro</h2>
                            <p class="mb-0">No hay sueños grandes si el café es demasiado corto.</p>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('registro/procesar') ?>" method="post">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control input-estetico" id="nombre" name="nombre"
                                        placeholder="Ej: Juan Pérez" value="<?= old('nombre') ?>" required>
                                </div>

                                <div class="mb-4">
                                    <label for="apellido" class="form-label">Apellido</label>
                                    <input type="text" class="form-control input-estetico" id="apellido" name="apellido"
                                        placeholder="Ej: González" value="<?= old('apellido') ?>" required>
                                </div>

                                <div class="mb-4">
                                    <label for="email" class="form-label">Correo electrónico</label>
                                    <input type="email" class="form-control input-estetico" id="email" name="email"
                                        placeholder="Ej: tu@email.com" value="<?= old('email') ?>" required>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="password" class="form-control input-estetico" id="confirmar_password"
                                        name="confirmar_password" placeholder="Repite tu contraseña" required>
                                </div>
