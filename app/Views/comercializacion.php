...
<head>
    ...
    <title>Comercialización | Tu Tienda de Café</title>
    <!-- Bootstrap CSS -->
...
<body style="background-color: var(--crema);">
    ...
    <!-- Hero Section -->
    <section class="hero-commercial text-white" style="padding-top: 15vh; padding-bottom: 10vh">
        <div class="container">
